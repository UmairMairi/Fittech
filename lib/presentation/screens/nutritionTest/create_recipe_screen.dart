                          ...
                          Builder(builder: (context) {
                            ...
                            return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return provider.selectedFood.isEmpty ? Container() : Column(
                                    crossAxisAlignment:
                      ...
                      Builder(
                        builder: (context) {
                          ...
                          return Row(
                            ...
                            children: [
                              Expanded(
                                child: Text("${provider.kcal} kcal", style: MyTextStyle.text1),
                              ),
                              Expanded(
                                child: Text(
                                  "P. ${provider.p}g",
                              ...
                              Expanded(
                                child: Text("C. ${provider.c}g", style: MyTextStyle.text1),
                              ),
                              Expanded(
                                child: Text("G. ${provider.g}g", style: MyTextStyle.text1),
                              ),
                            ],
                          );
                        }
                            ...
                            child: PrimaryButton(
                              ...
                              onPressed: () async{
                                ...
                                if(inputController.text.isEmpty){
                                  showMessage(context: context, msg: "Please! Enter Recipe Name");
                                }else{
                                 var response = await bloc.addRecipe(context: context,name: inputController.text);
                                 if(response != null && response['success']){
                                  bloc.selectedFood.clear();
                                  showMessage(context: context, msg: response['message'],success: true);
                                // ignore: use_build_context_synchronously
                                Navigator.pushNamed(context, RecipeListScreen.tag);
                                 }else{
                                  showMessage(context: context, msg: response['message']);
                                 }
                                }
                              },
                            ),
